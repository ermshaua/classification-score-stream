...
class ADWIN:
    ...
    def __init__(self, n_timepoints=10_000, delta=.01, excl_factor=5, verbose=0):
        self.n_timepoints = n_timepoints
        self.excl_factor = excl_factor
        self.verbose = verbose

        self.adwin = adwin.ADWIN(delta=delta)
    ...
    def _run(self, timepoint):
        ...
        self.adwin.add_element(timepoint)
        self.profile[-1] = self.adwin.variance

        if not self.adwin.detected_change():
            return self.profile
