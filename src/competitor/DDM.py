...
class DDM:
    ...
    def __init__(self, n_timepoints=10_000, out_control_level=20, min_num_instances=100, excl_factor=5, verbose=0):
        self.n_timepoints = n_timepoints
        self.excl_factor = excl_factor
        self.verbose = verbose

        self.ddm = ddm.DDM(min_num_instances=min_num_instances, out_control_level=out_control_level)
