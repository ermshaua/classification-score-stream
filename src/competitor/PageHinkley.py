...
class PageHinkley:
    ...
    def __init__(self, n_timepoints=10_000, threshold=50, min_instances=100, excl_factor=5, verbose=0):
        self.n_timepoints = n_timepoints
        self.excl_factor = excl_factor
        self.verbose = verbose

        self.ddm = drift_detection.PageHinkley(min_instances=min_instances, threshold=threshold)
